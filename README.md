...
```bash
% java -jar nats-samples/listener-sample/target/listener-sample-0.5.2.jar --nats.spring.server="nats://localhost:4222"
...
...
```bash
% java -jar nats-samples/processor-sample/target/processor-sample-0.5.2.jar --nats.spring.server="nats://localhost:4222"
...
